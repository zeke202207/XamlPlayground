...
public partial class ViewLocator : IDataTemplate
{
    public Control Build(object? data)
    {
        ...
        return data switch
        {
            ...
            StylesInspectorDockViewModel => new StylesInspectorDockView(),
            BindingsInspectorDockViewModel => new BindingsInspectorDockView(),
            ResourcesInspectorDockViewModel => new ResourcesInspectorDockView(),
            AnimationTimelineSheetDockViewModel => new AnimationTimelineSheetDockView(),
            StyleEditorDockViewModel => new StyleEditorDockView(),
            BindingEditorDockViewModel => new BindingEditorDockView(),
            ResourceEditorDockViewModel => new ResourceEditorDockView(),
